...
marks = [
    ...
    (['eric-oss-task-automation-ae-flow-automation-creates-route-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt')),
    (['eric-oss-task-automation-ae-flow-automation-deletes-route-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt')),
    (['eric-oss-task-automation-ae-flow-automation-rbac-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt')),
    (['eric-oss-task-automation-ae-flow-automation-realm-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt')),
    (['eric-oss-task-automation-ae-create-default-user-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt')),
    (['eric-oss-task-automation-ae-fa-realm-keycloak-user-hook'], ['Job'], pytest.mark.skip(reason='Not required, exempt'))
]
test_parameters = mark_test_parameters(spec_templates, marks)

@pytest.mark.parametrize(('template', 'kind', 'spec_template'), test_parameters)
